...
class TestUserRegistrationFlow:
    ...
    @pytest.mark.asyncio
    async def test_complete_user_registration_flow(self, client: AsyncClient, test_role):
...
class TestAdminFlow:
    ...
    @pytest.mark.asyncio
    async def test_admin_can_view_all_users(self, client: AsyncClient, test_admin_user, test_user):
    ...
    async def test_admin_can_add_roles(self, client: AsyncClient, test_admin_user):
        ...
        role_response = await client.post("/auth/addroles", json=role_data, cookies=cookies)
    ...
    @pytest.mark.asyncio
    async def test_regular_user_cannot_view_all_users(self, client: AsyncClient, test_user):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_duplicate_email_registration(self, client: AsyncClient, test_user, test_role):
    ...
    @pytest.mark.asyncio
    async def test_duplicate_phone_registration(self, client: AsyncClient, test_user, test_role):
...
class TestDatabaseIntegration:
    ...
    @pytest.mark.asyncio
    async def test_user_role_relationship_integrity(self, db_session: AsyncSession, test_user, test_role):
