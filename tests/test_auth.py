...
class TestAuthRouter:
    ...
    @pytest.mark.asyncio
    async def test_register_user_success(self, client: AsyncClient, user_data, test_role):
    ...
    @pytest.mark.asyncio
    async def test_register_user_already_exists(self, client: AsyncClient, user_data, test_user, test_role):
    ...
    @pytest.mark.asyncio
    async def test_register_user_invalid_data(self, client: AsyncClient, invalid_user_data, test_role):
    ...
    async def test_login_wrong_password(self, client: AsyncClient, test_user):
        ...
        assert response.status_code == 400  # IncorrectEmailOrPasswordException возвращает 400
...
class TestAuthDAO:
    ...
    @pytest.mark.asyncio
    async def test_role_dao_find_all(self, db_session: AsyncSession, test_role, test_admin_role):
...
class TestAuthModels:
    ...
    @pytest.mark.asyncio
    async def test_user_role_relationship(self, db_session: AsyncSession, test_user, test_role):
