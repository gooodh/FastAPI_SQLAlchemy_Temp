...
class TestSettings:
    ...
    def test_settings_default_values(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert settings.FORMAT_LOG == "{time:YYYY-MM-DD at HH:mm:ss} | {level} | {name}:{function}:{line} - {message}"
...
"""
    ...
    def test_log_format_customization(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert settings.FORMAT_LOG == custom_format
    ...
    def test_log_rotation_customization(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert settings.LOG_ROTATION == custom_rotation
